...
'                    var text="";',
'                    switch(status){',
'                         case "open":text="connect success";break;',
'                         case "close":text="disconnect";break;',
'                         case "error":text="connect failure";break;',
'                         default:alert("运行状态异常");break;',
'                      }',
'                      document.getElementById("slstatus").innerHTML=text;',
'                    }',
'				};',
'',
...
'					 SocketLog[address:<input type="text" id="address" value="ws://dev.zlo2o.cn:1229">&nbsp;&nbsp;Client_ID:<input type="text" id="client_id"><input type="button" value="save-socklog" onclick="savesl()"><font color=red id="slstatus"></font>]',
'				</div>',
